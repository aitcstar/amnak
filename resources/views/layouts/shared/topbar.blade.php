...
<div class="navbar-custom">
    ...
    <!--
            ...
            <li class="dropdown notification-list">
                <a href="{{route('usersEdit',['admin','users' ,'edit',Auth::user()->id] )}}" class="nav-link waves-effect waves-light">
                ...
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    @else
                        @if(Auth::user()->role_id == 0)
                            <img src="{{ url('companies/', Auth::user()->image) }}" alt="user-image" class="rounded-circle">
                        @else
                            <img src="{{ url('profile/', Auth::user()->image) }}" alt="user-image" class="rounded-circle">
                        @endif
                    @endif
        ...
        <div class="logo-box">
            ...
            <a href="/home" class="logo logo-light text-center">
                ...
                <span class="logo-lg">
                        <img src="{{url('frontend/images/Nlogo.png')}}" alt="Logo" height="80" >
                </span>
            </a>
        </div>
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-inline-block"> 
                <h3 class="mt-0"> مرحبا ,  {{{ Auth::user()->name }}} </h3>
            </li>
            <li>
