@extends('layouts.vertical', ['title' => 'إنشاء شركة', 'mode' => 'rtl'])
@section('css')
    <!-- Plugins css -->
...
بيانات الحساب
                    ...
                    <form method="POST" action="{{ route('companiesStore', ['admin', 'companies', 'store']) }}"  enctype="multipart/form-data">
                        @csrf
                                                        ...
                                                        <div class="col-sm-2 bg-c-lite-green user-profile">
                                                            <div class="card-block text-center text-white">
                                                                ...
                                                                <span class="btn btn-primary btn-file" style="margin: -92px -107px 0 0; border-radius: 7em; border-color: #01414d;">
                                                                    <i class="mdi mdi-square-edit-outline"></i> <input type="file" name="logo">
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-10">
                                                            <div class="card-block">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" value="{{ old('phone', '') }}" required>
                                                                        @if ($errors->has('phone'))
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="password" name="password"  autocomplete="new-password" required>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}" type="text" name="website" value="{{ old('website', '') }}" required>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" value="{{ old('address', '') }}" required>
