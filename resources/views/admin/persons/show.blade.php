                                    ...
                                    <div class="col-sm-2 bg-c-lite-green user-profile">
                                        <div class="card-block text-center text-white">
                                            <div class="m-b-25">
                                                ...
                                                @else
                                                    <img src="{{ url('employees/'.$person->id_image) }}"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input
                                                        ...
                                                        type="text" name="first" value="{{ $person->first_name }}" required>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input
                                                        ...
                                                        type="text" name="job_number" value="{{ $person->job_number }}" required>
