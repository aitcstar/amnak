@extends('layouts.vertical', ['title' => 'إنشاء أفراد', 'mode' => 'rtl'])
@section('css')
    <!-- Plugins css -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">إنشاء / أفراد</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-xl-12">
                <div class="card-box">
                    ...
                    <form method="POST" action="{{ route('personsStore', ['admin', 'persons', 'store']) }}"  enctype="multipart/form-data">
                        @csrf
