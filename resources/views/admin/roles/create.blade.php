@extends('layouts.vertical', ['title' => 'إنشاء أدوار', 'mode' => 'rtl'])
@section('css')
    <!-- Plugins css -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">إنشاء / أدوار</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
...
بيانات أدوار
                    ...
                    <form method="POST" action="{{ route('rolesStore', ['admin', 'roles', 'store']) }}"  enctype="multipart/form-data">
                        @csrf
