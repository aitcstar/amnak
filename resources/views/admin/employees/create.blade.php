@extends('layouts.vertical', ['title' => 'إنشاء موظف', 'mode' => 'rtl'])
@section('css')
    <!-- Plugins css -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">إنشاء / موظف</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-xl-12">
                <div class="card-box">
                    ...
                    <form method="POST" action="{{ route('employeesStore', ['admin', 'employees', 'store']) }}"  enctype="multipart/form-data">
                        @csrf
                                                ...
                                                <div class="card user-card-full">
                                                    <div class="row m-l-0 m-r-0">
                                                        <div class="col-sm-2 bg-c-lite-green user-profile">
                                                            <p class="m-b-10 f-w-600">صورة الهوية</p>
                                                            <div class="card-block text-center text-white">
                                                                ...
                                                                <span class="btn btn-primary btn-file" style="margin: -92px -107px 0 0; border-radius: 7em; border-color: #01414d;">
                                                                    <i class="mdi mdi-square-edit-outline"></i> <input type="file" name="id_image">
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-10">
                                                            <div class="card-block">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" value="{{ old('first_name', '') }}" required>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" value="{{ old('last_name', '') }}" required>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control {{ $errors->has('national_id') ? 'is-invalid' : '' }}" type="text" name="national_id" value="{{ old('national_id', '') }}" required>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control {{ $errors->has('date_of_birth') ? 'is-invalid' : '' }}" type="date" name="date_of_birth" value="{{ old('date_of_birth', '') }}" required>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control {{ $errors->has('height') ? 'is-invalid' : '' }}" type="text" name="height" value="{{ old('height', '') }}" required>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" type="text" name="weight" value="{{ old('weight', '') }}" required>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control {{ $errors->has('salary') ? 'is-invalid' : '' }}" type="text" name="salary" value="{{ old('salary', '') }}">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control {{ $errors->has('job_number') ? 'is-invalid' : '' }}" type="text" name="job_number" value="{{ old('job_number', '') }}">
